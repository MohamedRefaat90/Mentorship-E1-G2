...
import '../widgets/GetStartButton.dart';
    ...
    return Scaffold(
      body: DefaultTextStyle(
        ...
        child: AnimatedContainer(
          ...
          color: backgroundColors[selectedIndex].withOpacity(0.4),
          child: Stack(
                      ...
                      child: ClipPath(
                        ...
                        child: AnimatedContainer(
                          ...
                          decoration: BoxDecoration(
                            color: backgroundColors[selectedIndex],
                  ...
                  ? Positioned(
                      ...
                      child: Transform.rotate(
                        ...
                        child: ClipPath(
                          ...
                          child: AnimatedContainer(
                            duration: const Duration(milliseconds: 300),
                            color: backgroundColors[selectedIndex + 1]
                                .withOpacity(0.8),
                          ),
                        ),
                      ))
              ...
              Positioned(
                  ...
                  child: Transform.rotate(
                    ...
                    child: AnimatedContainer(
                      ...
                      duration: const Duration(milliseconds: 300),
                      color:
                          backgroundColors[selectedIndex + 1].withOpacity(0.9),
                    ),
                  )),
              Positioned(
                bottom: -60,
                ...
                child: Transform.rotate(
                  ...
                  child: AnimatedContainer(
                    ...
                    width: 200,
                    duration: const Duration(milliseconds: 300),
                    color: backgroundColors[selectedIndex].withOpacity(0.9),
                  ),
                ),
              ),
              Positioned(
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      GetStartButton(
                          pageValue: pageValue, pageController: pageController),
                    ],
                  ),
                ),
              ),
