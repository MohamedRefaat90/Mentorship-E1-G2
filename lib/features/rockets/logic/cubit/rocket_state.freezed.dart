...
class __$$InitialImplCopyWithImpl<T, $Res>
    extends _$RocketStateCopyWithImpl<T, $Res, _$InitialImpl<T>>
...
abstract class _Initial<T> implements RocketState<T> {
...
class __$$LoadingImplCopyWithImpl<T, $Res>
    extends _$RocketStateCopyWithImpl<T, $Res, _$LoadingImpl<T>>
...
abstract class Loading<T> implements RocketState<T> {
...
abstract class Success<T> implements RocketState<T> {
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'RocketState<$T>.error(error: $error)';
  }
...
abstract class Error<T> implements RocketState<T> {
